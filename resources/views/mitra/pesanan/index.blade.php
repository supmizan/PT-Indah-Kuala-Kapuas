            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif($order->pembayaran && $order->pembayaran->status === 'menunggu_verifikasi')
                        <span class="badge bg-info text-dark">Menunggu Verifikasi</span>
                        @elseif($order->pembayaran && $order->pembayaran->status === 'ditolak')
                        <span class="badge bg-danger">Ditolak</span>
                        <a href="{{ route('mitra.pembayaran.show', $order->id) }}" class="btn btn-sm btn-outline-primary ms-1">Upload Ulang</a>
                        @else
