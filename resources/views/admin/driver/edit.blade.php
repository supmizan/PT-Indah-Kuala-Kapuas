...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h3 class="fw-bold mb-0">Edit Data Driver</h3>
        ...
        <div class="card-custom">
            ...
            <form action="{{ route('admin.driver.update', $driver->id) }}" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        <label for="status" class="form-label fw-medium">Status Operasional</label>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="alamat" id="alamat" rows="3" class="form-control" required>{{ old('alamat', $driver->alamat) }}</textarea>
                    </div>
                </div>
